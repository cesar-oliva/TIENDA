...
namespace ServiceAFIP
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName="ServiceAFIP.LoginCMS")]
    public interface LoginCMS
    {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(ServiceAFIP.LoginFault), Action="", Name="fault")]
        ServiceAFIP.loginCmsResponse loginCms(ServiceAFIP.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceAFIP.loginCmsResponse> loginCmsAsync(ServiceAFIP.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public interface LoginCMSChannel : ServiceAFIP.LoginCMS, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<ServiceAFIP.LoginCMS>, ServiceAFIP.LoginCMS
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServiceAFIP.loginCmsResponse ServiceAFIP.LoginCMS.loginCms(ServiceAFIP.loginCmsRequest request)
        {
        ...
        {
            ServiceAFIP.loginCmsRequest inValue = new ServiceAFIP.loginCmsRequest();
            inValue.in0 = in0;
            ServiceAFIP.loginCmsResponse retVal = ((ServiceAFIP.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceAFIP.loginCmsResponse> ServiceAFIP.LoginCMS.loginCmsAsync(ServiceAFIP.loginCmsRequest request)
        {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceAFIP.loginCmsResponse> loginCmsAsync(string in0)
        {
            ServiceAFIP.loginCmsRequest inValue = new ServiceAFIP.loginCmsRequest();
            inValue.in0 = in0;
            return ((ServiceAFIP.LoginCMS)(this)).loginCmsAsync(inValue);
        }
